...
func (_m *Repository) CreateEvent(ctx context.Context, e *calendar.Event) (*calendar.Event, error) {
	ret := _m.Called(ctx, e)
...
func (_m *Repository) FindEventByID(ctx context.Context, id uuid.UUID) (*calendar.Event, error) {
